...
return [
    ...
    */
    ...
    /*
|--------------------------------------------------------------------------
| TRANZAK API Environment VARIABLES
|--------------------------------------------------------------------------
|
...
*/
    ...
    'tranzak' => [
        ...
        'currency_Code' => env('TRANZAK_CURRENCY', 'XAF'),
         ...
         *
         * @see https://docs.developer.tranzak.me/?javascript#payment-request-collection-api
         */
        'product' => env('TRANZAK_PRODUCT', 'collection'),
